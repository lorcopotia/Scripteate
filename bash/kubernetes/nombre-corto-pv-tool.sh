...
for elem in $listaNONPROD; do
  ...
  #oc get pv -oyaml $elem | sed '4d;5d;6d;7d; /resourceVersion/d; /selfLink/d; /uid/d; /creationTimestamp/d; s/nombre-servidor/&.example.com/; /status/,\$d' > nombre-corto-new-pvs/$elem-pv.yaml
done
